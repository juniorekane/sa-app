...
class EmotionServiceTest {
    ...
    void findAllEmotionSuccess() {
        ...
        // Prepare test data
        EmotionResponse mockEmotionResponse = new EmotionResponse(mockEmotion.getId(), mockEmotion.getText(),
                mockEmotion.getType(),
    ...
    void findAllEmotionFailedDueToEmptyListException() {
        ...
        // Execute test
        ElementNotFoundException ex = Assertions.assertThrows(ElementNotFoundException.class,
                () -> emotionService.findAllEmotion());
