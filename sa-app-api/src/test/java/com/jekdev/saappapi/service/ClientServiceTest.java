...
class ClientServiceTest {
  ...
  void createClientFailure() {
    ...
    PresentElementException ex =
        Assertions.assertThrows(PresentElementException.class, () -> clientService.createClient(mockClientRequest));
  ...
  void getAllClientsFailureWithNoClients() {
    ...
    ElementNotFoundException exception =
        Assertions.assertThrows(ElementNotFoundException.class, () -> clientService.getAllClients());
  ...
  void searchClientFailureNoClientFound() {
    ...
    // Execute test
    ElementNotFoundException exception =
        Assertions.assertThrows(ElementNotFoundException.class, () -> clientService.searchClient(mockClient.getId()));
