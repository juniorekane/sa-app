...
import com.jekdev.com.controller.ClientController;
...
class GlobalExceptionHandlerTest {
  ...
  @MockitoBean private EmotionService emotionService;
  ...
  void handleElementNotFoundException() throws Exception {
    ...
    // Execute test
    mockMvc
        .perform(MockMvcRequestBuilders.get(SEARCH_PATH, CLIENT_ID))
  ...
  void handlePresentElementException() throws Exception {
    ...
    doThrow(new PresentElementException("Client already exists. Please use a different email address."))
        .when(clientService)
        .createClient(any(ClientRequest.class));
