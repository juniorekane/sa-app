...
import com.jekdev.com.dto.EmotionSummary;
 ...
 *
 * <p>The {@code AppMapper} class provides various methods to facilitate the transformation of objects between different
 * layers of the application, enabling effective communication and data handling. Specifically, it includes:
 *
 * <p>- Mapping a {@code ClientRequest} DTO to a {@code Client} entity. - Mapping a {@code Client} entity to a {@code
 ...
 *
 * <p>These conversion methods help ensure separation of concerns and simplify data handling throughout different
 * components of the application, such as controllers, services, and persistence layers.
 *
 * <p>Annotated with {@code @Component}, this class is managed as a Spring bean, making it available for dependency
...
public class AppMapper {
   ...
   *
   * <p>This method transfers data from the {@code ClientRequest} DTO to a new instance of the {@code Client} entity.
   * Specifically, it sets the {@code email} field of the {@code Client} entity based on the corresponding value in the
   * {@code ClientRequest}.
   *
   * @param clientRequest the {@link ClientRequest} object containing client-specific data; must not be null
   ...
   *
   * <p>This method converts the data from a {@code Client} entity into a {@code ClientResponse} object, which is used
   ...
   *
   * @param client the {@link Client} entity to be mapped; must not be null
   ...
   *
   * <p>This method converts the data from an {@code Emotion} entity into an {@code EmotionSummary} object, which is a
   * lightweight representation containing only the essential details of the emotion, namely its ID, text, and type.
   *
   * @param emotion the {@link Emotion} entity to be mapped; must not be null
   ...
   *
   * <p>This method transfers the data from an {@code EmotionRequest} DTO to a new {@code Emotion} entity. It maps key
   * attributes, including the text and type of the emotion, as well as the associated client. The client information is
   * mapped using the {@code mapClientRequestToEntity} method.
   *
   * @param emotionRequest the {@link EmotionRequest} object containing the emotion details to be mapped; must not be
   *     null
   ...
   *
   * <p>This method converts the data from an {@code Emotion} entity into an {@code EmotionResponse} object, which is
