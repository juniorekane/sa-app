 ...
 * Provides methods for creating, retrieving, and searching client records in the database.
 */
@Service
@AllArgsConstructor
@Slf4j
public class ClientService {
     ...
     * @return an {@code Optional} containing the found {@code Client} if it exists, or an empty {@code Optional} if no client is found
     */
